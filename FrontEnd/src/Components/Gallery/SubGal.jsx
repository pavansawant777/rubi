...
import SubCatCard from "../Projects/SubCatCard";
export default function SubGal(){
    ...
    return(<>
    <Header heading="Gallery Categories"/>
<div className="container p-5">
    ...
    <div className="row mt-5 ">
        {imgs && imgs.map((i)=>{
         return( <SubCatCard img={i.image} category={i.category} id={i._id}/>
         )
        })}
    </div>
</div>
