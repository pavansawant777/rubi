(function($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    createLightBox(gallery, lightboxId, navigation) {
      gallery.append(`<div class="modal fade" style="margin-top:150px;" id="${
    ...
    showItemTags(gallery, position, tags) {
      var tagItems =
        '<li class="nav-item"><a class="nav-link text-dark " href="#" data-images-toggle="all">all</a></li>';
      $.each(tags, function(index, value) {
        tagItems += `<li class="nav-item  ">
                <a class="nav-link text-dark" href="#" data-images-toggle="${value}">${value}</a></li>`;
      });
